...
## About Me
I'm a passionate software developer and computer science student with experience across multiple programming languages and technologies. I enjoy building everything from low-level embedded systems to full-stack web applications.
...
- **Backend**: Node.js, Express.js, MongoDB with session management
- **Features**: User authentication, posts, groups, notifications
- RESTful API design with middleware architecture
- Real-time notifications and search functionality

### 🤖 [Game AI Techniques](https://github.com/Cecil-B-Liv/Game-Technique)
Implementation of AI steering behaviors for game development
...
- Custom bootloader and kernel implementation
...
- **Game Development**: Physics simulation, AI techniques, and emulator development
...
- 💡 Open to discussing software engineering, game development, and system programming

---

⭐️ From [Cecil-B-Liv](https://github.com/Cecil-B-Liv)
